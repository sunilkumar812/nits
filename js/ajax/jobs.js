jQuery(document).ready(function($) {
    ...
    $('.job-filter').on('click', function() {
      ...
      let currentPage = 1;
      $('.job-filter').removeClass('bg-white text-blue-700 border-l-4 border-blue-70');
      ...
      $.ajax({
        ...
        error: function (xhr) {
            ...
            $('#jobs-contanier').html('<div class="swiper-slide p-5 text-red-600">An error occurred. Please try again.</div>');
            $('#casestudy-loader').addClass('hidden');
        }
      });
    });
