...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
			...
			<div class="main-width flex items-center justify-between 2xl:py-0 3xl:py-0 lg:py-0 py-5">
				...
				<div class="hidden lg:flex lg:gap-3 xl:gap-3 md:gap-3 gap-3 z-1">
					<?= get_template_part('partials/core/partial', 'button_primary', [
						'class' => 'btn-primary font-bold px-[14px] py-[8px] rounded-md !text-base 3xl:text-lg',
						'text' => 'Get a Demo',
						'link' =>  '/contact',
					]); ?>
					<?= get_template_part('partials/core/partial', 'button_primary', [
						'class' => 'btn-white font-bold px-[15px] py-[8px] rounded-md !text-base 3xl:text-lg',
						'text' => 'Get Started',
						'link' =>  '/contact',
					]); ?>
				</div>
		...
		<?php if ($mobileDetect->isMobile()) : ?>
			<div class="main-mobile-nav fixed inset-0 bg-nitsPrimary w-full h-full z-5 pt-[150px] md:pt-36 overflow-hidden transition-all duration-500 opacity-0 pointer-events-none">
